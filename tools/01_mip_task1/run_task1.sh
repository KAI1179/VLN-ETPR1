...
DATA_SEARCH_ROOTS=${DATA_SEARCH_ROOTS:-"$HOME/code/ETP-R1-main/data $HOME/code/ETP-R1-snapshot/ETP-R1/data $HOME/run/ETP-R1/data $HOME/data /data $HOME/datasets"}
MIP_DIR=$WORKDIR/MIP
