...
class GreedyGeodesicFollower:
    ...
    def __gt__(self, other):
        ...
        Method generated by attrs for class GreedyGeodesicFollower.
        """
    def __init__(self, pathfinder: habitat_sim._ext.habitat_sim_bindings.PathFinder, agent: habitat_sim.agent.agent.Agent, goal_radius: typing.Optional[float] = None, *, stop_key: typing.Optional[typing.Any] = None, forward_key: typing.Optional[typing.Any] = None, left_key: typing.Optional[typing.Any] = None, right_key: typing.Optional[typing.Any] = None, fix_thrashing: bool = True, thrashing_threshold: int = 16) -> None:
        """
        Constructor
