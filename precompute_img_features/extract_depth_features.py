        ...
        while num_finished_workers < num_workers:
            ...
            if res is None:
                ...
                if args.out_image_logits:
                    ...
                    data = fts
                outf.create_dataset(
                    key, data.shape, dtype="float32", compression="gzip"
                )
                outf[key][...] = data
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--checkpoint_file", default="data/ddppo-models/gibson-2plus-resnet50.pth"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--img_db",
        default="pretrain_src/img_features/habitat_256x256_vfov60_depth.hdf5",
    )
    parser.add_argument("--out_image_logits", action="store_true", default=False)
    parser.add_argument(
        "--output_file",
        default="pretrain_src/img_features/ddppo_resnet50_depth_features.hdf5",
    )
