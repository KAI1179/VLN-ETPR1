...
- [x] 按 instruction-derived mention partition 分解 object/region category P/R/F1，确认 unmentioned category 是否更难（[2026-07-23 结果](2026-07-23.md)）；
- [x] 用同一 mention partition 分解 pooled spatial IoU/cell F1 并绘制 epoch 1–10 空间与类别曲线（[2026-07-23 结果](2026-07-23.md#mentionedunmentioned-空间质量)）；
- [ ] 对 full target 与 mentioned-only target 做短训及下游导航对照。
