...
class MoveHighToLowAction(SimulatorTaskAction):
    ...
    def turn(self, angle):
        ...
        turn_unit = (
            ...
            .agent_config.action_space[left_action]
            .actuation.amount
        )
            ...
            if forward_step > 0:
                ...
                if init_try_angle == 90:  # from left to right
                    turn_seqs = [
                        ...
                        {
                            "head_turns": [right_action],
                            "tail_turns": [right_action] * 2,
                        },  # 60
                        {
                            "head_turns": [right_action],
                            "tail_turns": [right_action],
                        },  # 30
                        {
                            "head_turns": [right_action] * 2,
                            "tail_turns": [left_action],
                        },  # -30
                        {
                            "head_turns": [right_action],
                            "tail_turns": [left_action] * 2,
                        },  # -60
                        {
                            "head_turns": [right_action],
                            "tail_turns": [left_action] * 3,
                        },  # -90
                    ]
